...
public class Category {
    ...
    public static void main(String[] args) {
        Book b1 = new Magazine("A", 100, 2021, "ABC", 300, "AA");
        Book b2 = new Magazine("B", 200, 2022, "ABC", 400, "BB");
        Book b3 = new Magazine("C", 300, 2023, "BCD", 500, "CC");
        ...
        Book b4 = new RefBook("C", 121, 2021, "BCD", 6000, "CC");
        Book b5 = new RefBook("E", 200, 2021, "BCD", 7000, "DD");
        Book b6 = new RefBook("F", 300, 2022, "BCD", 8000, "EE");
        b4.addChapter(c1);
        b4.addChapter(c2);
        b5.addChapter(c3);
        b5.addChapter(c4);
        ...
        //C11
        System.out.println(category.isMagazineHaveName("AA"));
        System.out.println(category.isMagazineHaveName("WET"));
        //C12
